      ...
      >
        ...
        >
          ...
          <Text style={[styles.cardDesc, { color: theme.colors.onSurface }]}>
            Erstelle einen Einladungscode für {currentHousehold?.name}. Das neue
            Mitglied gibt diesen Code bei der Registrierung ein.
          </Text>
        ...
        {generatedCode && (
          ...
          >
            <Text style={[styles.codeLabel, { color: theme.colors.onSurface }]}>
              Einladungscode
            </Text>
